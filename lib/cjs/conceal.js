...
class Conceal {
    constructor(password, encoding = 'base64', keyStr = utilities_1.DEFAULT_KEY, algo = 'aes-256-gcm') {
        this.password = password;
        this.key = Buffer.from(keyStr, keyStr === utilities_1.DEFAULT_KEY ? 'base64' : encoding);
